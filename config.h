...
static const char *altbarcmd        = "$HOME/Scripts/launch.sh"; /* Alternate bar launch command */
...
static const char col_pink[]        = "#de0480";
...
static const char *rofi[] = {"rofi", "-i", "-show", "drun", "-modi", "drun", "-show-icons", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_F7,     spawn,          {.v = brightnessup} },
	{ MODKEY,                       XK_F6,     spawn,          {.v = brightnessdown} },
